...
- Unit: Vitest — scenario engine, primitivos individuais (delay/error-response/connection-reset/unavailable/malformed-response/stale-response), matching de rota, guardrail
...
55 testes, todos passando (`npm test`).
